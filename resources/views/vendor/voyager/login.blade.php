    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-5 col-md-4 login-sidebar">
            ...
            <div class="login-container">
                ...
                <p>Witaj w panelu administracyjnym strony Fundacji In Posterum. Zaloguj się.</p>
                ...
                <form action="{{ route('voyager.login') }}" method="POST">
                    ...
                    <div class="form-group form-group-default" id="emailGroup">
                        ...
                        <div class="controls">
                            <input type="text" name="email" id="email" value="{{ old('email') }}" placeholder="adres email" class="form-control" required>
                         </div>
                    </div>
                    ...
                    <button type="submit" class="btn btn-block login-button">
                        <span class="signingin hidden"><span class="voyager-refresh"></span> Sprawdzam dane...</span>
                        <span class="signin">Zaloguj się</span>
                    </button>
